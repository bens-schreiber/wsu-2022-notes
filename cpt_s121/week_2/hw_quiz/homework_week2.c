...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    printf("Total Sales: %f", sales_tax_rate * item_cost);
    ...
    */
    printf("Q3 Volume of a right rectangular pyramid ");
    double L;
    double W;
    double H;
    ...
    */
    printf("Q4 Total Parrallel Resistance");
    R1 = 0;
    R2 = 0;
    R3 = 0;
    setIntValue("R1", &R1);
    ...
    */
    printf("Q4 Character Encoding");
    int shift_int;
    setIntValue("Shift int", &shift_int);
    printf("%c", (char) ('a' + 'A' - shift_int));
